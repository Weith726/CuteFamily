...
<body>
	...
	<nav class="navbar fixed-top">
		<div class="icon">
			<a href="<%=request.getRequestURI()%>">Cute:)<span style="color:#00E8E8;">Family</span>
			</a>
	...
	<li class="nav-item-single">
		<a class="nav-link" href="<%=request.getContextPath()%>/back-end/emp/listAllEmp.jsp"><svg class="bi bi-unlock" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<div class="main col-xl-10">
	...
	<form>
		預約日期：<input type="date" name="">
		預約時段：<select name="optsession">
			<option value="session1">9:00~12:00</option>
			<option value="session2">13:30~17:00</option>
			<option value="session3">18:00~8:30</option>
			　
