...
<%-- 			<td>${optVO.maximum}</td> --%>
	...
	<span class="mainTitle">確認會員資料/填寫症狀描述(非必填)</span>
	<FORM METHOD="post" ACTION="apptStart.do" name="form1" id="form1"
		...
		<table class="memTable">
			...
			<tr>
				<th>選擇寵物</th>
				<td>
					<select size="1" name="petNo" style="width:247px;">
<%-- 					下方member.memNo的member是一個MemberVO，在原本session裡面--%>
							<option value="">未選擇
						<c:forEach var="petVO" items="${petSvc.getPetsFromThisMember(member.memNo)}">
<%-- 						<c:forEach var="petVO" items="${petSvc.getPetsFromThisMember('M0005')}"> --%>
			...
			<tr>
				<th>症狀描述</th>
				<td>
					<textarea id="symdesc" name="symdesc" rows="4" cols="50" maxlength="100"></textarea>
		...
		<br> <input type="hidden" name="action" value="insert"> 
			...
			<input type="hidden" name="sessionNo" value="${optVO.sessionNo}"> 
			<input type="hidden" name="seqNo" value="${optVO.currentCount+1}">
		<div style="width:100%" align="center">
			<input class="submit" type="submit" value="確定預約">
		</div>
